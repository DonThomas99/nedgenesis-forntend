    ...
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto section-padding w-full pt-32 md:pt-36">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <motion.p {...fadeUp(0.35)} className="section-subtitle mt-6">
              NEDGENESIS LLP delivers world-class web-app development and digital
              marketing solutions that help businesses scale, convert, and lead globally.
            </motion.p>
            ...
            <motion.div {...fadeUp(0.5)} className="flex flex-wrap gap-4 mt-10">
              ...
              >
                Start Your Project <HiArrowRight size={18} />
              </button>
              <button
                onClick={() => document.querySelector('#portfolio')?.scrollIntoView({ behavior: 'smooth' })}
                className="btn-outline"
              >
                <HiPlay size={18} /> View Our Work
              </button>
            </motion.div>
            ...
            <motion.div {...fadeUp(0.65)} className="flex items-center gap-6 mt-12 flex-wrap">
              <div className="flex -space-x-3">
                {['#6c63ff', '#00d4ff', '#a78bfa', '#34d399'].map((color, i) => (
                  <div
                    key={i}
                    className="w-9 h-9 rounded-full border-2 border-ng-dark flex items-center justify-center text-xs font-bold"
              ...
              <p className="text-ng-text text-sm">
                <span className="text-white font-semibold">50+ clients</span> trust us globally
              </p>
            </motion.div>
          </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="space-y-3">
                  <div className="h-3 bg-ng-border rounded-full w-3/4" />
                  <div className="h-3 bg-ng-border rounded-full w-1/2" />
                  <div className="h-3 bg-gradient-to-r from-ng-accent to-ng-cyan rounded-full w-5/6" />
                  <div className="h-3 bg-ng-border rounded-full w-2/3" />
                </div>
                <div className="grid grid-cols-2 gap-3 mt-6">
                  <div className="bg-ng-border/50 rounded-xl p-4">
                    <p className="text-2xl font-black text-white">50+</p>
                    <p className="text-ng-text text-xs mt-1">Projects Done</p>
                  </div>
                  <div className="bg-ng-border/50 rounded-xl p-4">
                    <p className="text-2xl font-black gradient-text">98%</p>
                    <p className="text-ng-text text-xs mt-1">Client Satisfaction</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute -top-6 -right-6 card px-4 py-3 z-20"
              >
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
                  <span className="text-xs font-semibold text-white">Live Projects</span>
                </div>
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -left-6 card px-4 py-3 z-20"
              >
                <p className="text-xs text-ng-text">Countries Served</p>
      ...
      >
        ...
        <motion.div
          ...
          className="w-0.5 h-8 bg-gradient-to-b from-ng-accent to-transparent"
        />
      </motion.div>
    </section>
  )
